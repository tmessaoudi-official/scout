...
| 14 | Collective.work source: one offer per mail, company from the subject, `place_absent` declared | M | done | - | src/php/Job/** config/job/sources.json tests/fixtures/job/collective/** tests/php/Job/** tests/sabotage-check.sh |
<!-- /progress-block -->
### Blocked
